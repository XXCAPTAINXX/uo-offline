...
- [ ] **H07 — Island mining.** Dismount and use a pickaxe on an Island ore outcrop east of headquarters. The 20 mineable tiles span four normal 8×8 resource banks. Try targets near (4234, 2888), (4240, 2888), (4234, 2897), and (4240, 2897), standing within two tiles. Each bank has a separate ore supply; rocks inside the same bank share depletion. Exhaust one, check another still produces ore, then return after the normal 10–20 minute refill. The larger decorative boulders are not mining targets.
