...
public partial class ArcaneSupplyStone : Item
{
    ...
    {
        private static readonly string[] Names = ["Full Magery spellbook", "Full Necromancy spellbook", "Full Chivalry book", "Full Spellweaving book", "Full Bushido book", "Full Ninjitsu book", "Runebook", "Runic atlas — 48 locations", "Bag of sending — 30 charges", "Translocation powder — 10 doses", "Fortification powder — 10 uses", "Clothing bless deed", "Equipment bless deed", "Blank recall rune", "Reagent bundle — 100 of each", "Bandages — 500", "Arrows — 500", "Bolts — 500", "Recall scrolls — 50", "Potion bundle — 10 of each", "Resource Ledger — combine commodity deeds"];
        private static readonly int[] Prices = [500, 1500, 1000, 2000, 1000, 1000, 500, 5000, 2500, 1000, 5000, 10000, 50000, 50, 3000, 500, 1000, 1000, 2000, 1500, 1000];
        ...
        public Item CreateItem(int index)
        {
            Item item = index switch
            {
                ...
                18 => new RecallScroll(50), 20 => new HavenResourceLedger(), _ => PotionBundle()
            };
