...
public partial class ArcaneSupplyStone : Item
{
    ...
    internal sealed class Menu : ItemListMenu, IHavenShop
    {
        ...
        private static readonly int[] Prices = [500, 1500, 1000, 2000, 1000, 1000, 500, 5000, 2500, 1000, 5000, 10000, 50000, 50, 3000, 500, 1000, 1000, 2000, 1500, 1000, 15000];
        ...
        public Item CreateItem(int index)
        {
            Item item = index switch
            {
                ...
                18 => new RecallScroll(50), 20 => new HavenResourceLedger(), 21 => new HavenResourceSatchel(), _ => PotionBundle()
            };
