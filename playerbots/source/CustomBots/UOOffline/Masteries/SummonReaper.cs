...
namespace Server.Spells.SkillMasteries
{
    public class SummonReaperSpell : SkillMasterySpell
    {
        ...
        public override bool CheckCast()
        {
            ...
            if (Caster is PlayerMobile player && Server.Engines.MLQuests.MLQuestSystem.GetContext(player)?.Spellweaving != true)
            {
    ...
    {
        [SerializableField(0)] private int _summonDispelDifficulty;

        public override double DispelDifficulty { get { return _summonDispelDifficulty; } }
        public override double DispelFocus { get { return 45.0; } }

        private long _NextAura = Core.TickCount + 3000;
            ...
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1)
        {
            ...
            SetSkill(SkillName.Magery, Math.Max(100, 75 * scale));
            SetSkill(SkillName.EvalInt, Math.Max(100, 75 * scale));
            ...
            _summonDispelDifficulty = 91 + (int)((caster.Skills[SkillName.Spellweaving].Base * 83) / 5.2);
        ...
        private void DoAura()
        {
            ...
            using var targets = MasteryTargeting.Acquire(this, this, Map, 4);
