    ...
    public class PlayingTheOddsSpell : SkillMasterySpell
    {
        ...
        public override void OnCast()
        {
            ...
            if (wep != null && CheckSequence())
            {
                ...
                MasteryBuffInfo.AddBuff(Caster, new MasteryBuffInfo(BuffIcon.PlayingTheOddsDebuff, 1155913, 1156091, duration, Caster));
                ...
                using var targets = MasteryTargeting.Acquire(Caster, Caster.Location, Caster.Map, 5);
        ...
        public override void AddPartyEffects(Mobile m)
        {
            ...
            {
                string args = String.Format("{0}\t{1}\t{2}", Caster.Name, _HCIBonus.ToString(), _SSIBonus.ToString());
                MasteryBuffInfo.AddBuff(m, new MasteryBuffInfo(BuffIcon.PlayingTheOdds, 1155913, 1155998, Expires - Core.Now, m, args));
        ...
        {
            MasteryBuffInfo.RemoveBuff(m, BuffIcon.PlayingTheOdds);
        }
