    ...
    public class CalledShotSpell : SkillMasterySpell
    {
        ...
        public override void OnCast()
        {
            if (CheckSequence())
            {
                ...
                MasteryBuffInfo.AddBuff(Caster, new MasteryBuffInfo(BuffIcon.CalledShot, 1156025, 1156026, duration, Caster, String.Format("{0}\t{1}", _HCIBonus.ToString(), _DamageBonus.ToString())));
        ...
        {
            MasteryBuffInfo.RemoveBuff(Caster, BuffIcon.CalledShot);
        }
