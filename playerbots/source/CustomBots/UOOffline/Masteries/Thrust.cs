...
namespace Server.Spells.SkillMasteries
{
    public class ThrustSpell : SkillMasterySpell
    {
        ...
        public override void OnCast()
        {
            ...
            MasteryBuffInfo.AddBuff(Caster, new MasteryBuffInfo(BuffIcon.Thrust, 1155989, 1155990, String.Format("{0}\t{1}\t{2}", AttackModifier.ToString(), DefenseModifier.ToString(), ScaleMana(30).ToString())));
		...
		public override void OnHit(Mobile defender, ref int damage)
		{
            ...
            MasteryBuffInfo.AddBuff(defender, new MasteryBuffInfo(BuffIcon.ThrustDebuff, 1155989, 1156234, TimeSpan.FromSeconds(8), defender, DefenseModifier.ToString()));
		...
		private void Reset()
		{
            ...
            if (Target != null)
            {
                MasteryBuffInfo.RemoveBuff(Target, BuffIcon.ThrustDebuff);
            }
		}
        ...
        private class InternalTimer : Timer
        {
                ...
                : base(TimeSpan.FromMilliseconds(250), TimeSpan.FromMilliseconds(250))
            {
                ...
                Expires = Core.Now + TimeSpan.FromSeconds(8);
                Start();
            }
