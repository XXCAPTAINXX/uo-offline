   ...
   public class ToleranceSpell : SkillMasterySpell
   {
        ...
        public override void OnCast()
        {
			if(CheckSequence())
			{
				...
				MasteryBuffInfo.AddBuff(Caster, new MasteryBuffInfo(BuffIcon.Tolerance, 1155926, 1156063)); // Reduces poison strength when poisoned at the cost of stamina.
			}
        ...
        {
            MasteryBuffInfo.RemoveBuff(Caster, BuffIcon.Tolerance);
        }
