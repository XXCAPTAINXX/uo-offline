...
namespace Server.Spells.SkillMasteries
{
    public class PierceSpell : SkillMasteryMove
    {
        ...
        public override TextDefinition AbilityMessage { get { return (TextDefinition)1155991; } } // You ready yourself to pierce your opponent!
        ...
        public override void OnHit(Mobile attacker, Mobile defender, int damage)
        {
            ...
            if (weapon != null && (_Table == null || !_Table.ContainsKey(attacker)))
            {
                ...
                MasteryBuffInfo.AddBuff(defender, new MasteryBuffInfo(BuffIcon.Pierce, 1155994, 1155995, TimeSpan.FromSeconds(10), defender, (drain / 7).ToString()));
