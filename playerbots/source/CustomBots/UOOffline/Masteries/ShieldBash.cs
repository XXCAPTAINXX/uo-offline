    ...
    public class ShieldBashSpell : SkillMasterySpell
    {
        ...
        public override void OnCast()
        {
            if (CheckSequence())
            {
                ...
                MasteryBuffInfo.AddBuff(Caster, new MasteryBuffInfo(BuffIcon.ShieldBash, 1155923, 1156093, duration, Caster));
        ...
        {
            MasteryBuffInfo.RemoveBuff(Caster, BuffIcon.ShieldBash);
        }
