...
namespace Server.Spells.SkillMasteries
{
    public class StaggerSpell : SkillMasteryMove
    {
        ...
        public override TextDefinition AbilityMessage { get { return (TextDefinition)1155980; } } // *You ready yourself to stagger your opponent!*
        ...
        public override void OnHit(Mobile attacker, Mobile defender, int damage)
        {
            ...
            MasteryBuffInfo.AddBuff(defender, new MasteryBuffInfo(BuffIcon.Stagger, 1155981, 1155982, TimeSpan.FromSeconds(10), defender, ((int)skills / 2).ToString()));
