...
namespace Server.Spells.SkillMasteries
{
    public class ShadowSpell : SkillMasterySpell
    {
        ...
        public override bool CheckCast()
        {
            ...
            {
                spell.Expire();
                MasteryBuffInfo.RemoveBuff(Caster, BuffIcon.Shadow);
                return false;
            }
        ...
        public override void OnCast()
        {
            if (CheckSequence())
            {
                ...
                MasteryBuffInfo.AddBuff(Caster, new MasteryBuffInfo(BuffIcon.Shadow, 1155910, 1156059, TimeSpan.FromSeconds(duration), Caster)); // Increases difficulty to be detected while hidden. <br>Increases difficulty to unhide from taking damage.
            }
