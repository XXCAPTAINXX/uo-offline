...
namespace Server.Spells.SkillMasteries
{
    public class WhisperingSpell : SkillMasterySpell
    {
		...
		public override bool CheckCast()
		{
            ...
            if (Caster is not PlayerMobile player || player.AllFollowers == null || player.AllFollowers.Count == 0)
            {
        ...
        public override void OnCast()
        {
			if(CheckSequence())
			{
				...
				MasteryBuffInfo.AddBuff(Caster, new MasteryBuffInfo(BuffIcon.Whispering, 1155932, 1156106, duration, Caster, _EnhancedGainChance.ToString()));
