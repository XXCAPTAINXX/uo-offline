    ...
    public class ElementalFurySpell : SkillMasterySpell
    {
        ...
        public override void OnCast()
		{
			if(CheckSequence())
			{
                ...
                MasteryBuffInfo.AddBuff(Caster, new MasteryBuffInfo(BuffIcon.ElementalFury, 1156018, 1156019, duration, Caster, String.Format("{0}\t69\t{1}", _Type.ToString(), _MaxAdd.ToString())));
        ...
        public override void OnHit(Mobile defender, ref int damage)
		{
            ...
            MasteryBuffInfo.AddBuff(defender, new MasteryBuffInfo(BuffIcon.ElementalFuryDebuff, 1155920, 0, ""));
            ...
            if (_Table[defender] >= 69)
			{
                ...
                MasteryBuffInfo.RemoveBuff(defender, BuffIcon.ElementalFuryDebuff);
        ...
        {
            MasteryBuffInfo.RemoveBuff(Caster, BuffIcon.ElementalFury);

            if (_Table != null)
            {
                foreach (Mobile m in _Table.Keys)
                    MasteryBuffInfo.RemoveBuff(m, BuffIcon.ElementalFuryDebuff);
