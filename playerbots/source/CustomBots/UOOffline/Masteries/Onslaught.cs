...
namespace Server.Spells.SkillMasteries
{
    public class OnslaughtSpell : SkillMasteryMove
    {
        ...
        public override TextDefinition AbilityMessage { get { return (TextDefinition)1156007; } } // *You ready an onslaught!*
        ...
        public override void OnHit(Mobile attacker, Mobile defender, int damage)
        {
            ...
            if (weapon != null && !HasOnslaught(attacker, defender))
            {
                ...
                ResistanceMod mod = new ResistanceMod(resistType, "Mastery Onslaught", -amount);
                ...
                MasteryBuffInfo.AddBuff(defender, new MasteryBuffInfo(BuffIcon.Onslaught, 1156009, 1156010, TimeSpan.FromSeconds(duration), defender, String.Format("{0}\t{1}", amount.ToString(), resistType.ToString()))); // -~2_VAL~% ~1_RESIST~ Debuff.
        ...
        {
            MasteryBuffInfo.RemoveBuff(from, BuffIcon.Onslaught);
        }
