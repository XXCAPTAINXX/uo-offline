...
namespace Server.Spells.SkillMasteries
{
	public class InvigorateSpell : BardSpell
	{
		...
		{
			m_NextHeal = Core.Now + TimeSpan.FromSeconds(4);
		}
        ...
        public override void AddPartyEffects(Mobile m)
        {
            ...
            MasteryBuffInfo.AddBuff(m, new MasteryBuffInfo(BuffIcon.Invigorate, 1115613, 1115730, args.ToString()));
        ...
        {
            MasteryBuffInfo.RemoveBuff(m, BuffIcon.Invigorate);
