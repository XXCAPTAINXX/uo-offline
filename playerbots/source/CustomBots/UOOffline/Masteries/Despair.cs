	...
	public class DespairSpell : BardSpell
	{
		...
		public void OnTarget( Mobile m )
		{
            ...
            else if (CheckHSequence(m))
            {
                ...
                MasteryBuffInfo.AddBuff(m, new MasteryBuffInfo(BuffIcon.DespairTarget, 1115741, 1115743, args.ToString()));
                MasteryBuffInfo.AddBuff(Caster, new MasteryBuffInfo(BuffIcon.DespairCaster, 1115741, 1115743, args.ToString()));
        ...
        {
            MasteryBuffInfo.RemoveBuff(Target, BuffIcon.DespairTarget);
            MasteryBuffInfo.RemoveBuff(Caster, BuffIcon.DespairCaster);
        }
