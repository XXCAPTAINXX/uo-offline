    ...
    public class WarcrySpell : SkillMasterySpell
    {
        ...
        public override void OnCast()
        {
            if (CheckSequence())
            {
                ...
                MasteryBuffInfo.AddBuff(Caster, new MasteryBuffInfo(BuffIcon.Warcry, 1155906, 1156058, TimeSpan.FromSeconds(10), Caster, String.Format("{0}\t{1}", _Radius.ToString(), _DamageMalus.ToString())));
