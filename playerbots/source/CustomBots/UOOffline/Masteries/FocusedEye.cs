    ...
    public class FocusedEyeSpell : SkillMasterySpell
    {
        ...
        public override void OnCast()
        {
            if (CheckSequence())
            {
                ...
                MasteryBuffInfo.AddBuff(Caster, new MasteryBuffInfo(BuffIcon.FocusedEye, 1156003, 1156004, String.Format("{0}\t{1}", _PropertyBonus.ToString(), ScaleUpkeep().ToString()))); // +~1_VAL~% Hit Chance Increase.<br>Mana Upkeep Cost: ~2_VAL~.
        ...
        {
            MasteryBuffInfo.RemoveBuff(Caster, BuffIcon.FocusedEye);
        }
