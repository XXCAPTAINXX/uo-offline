    ...
    public class WhiteTigerFormSpell : SkillMasterySpell
    {
        ...
        public override void OnCast()
        {
            ...
            else if (CheckSequence())
            {
                ...
                {
                    AnimalForm.RemoveContext(Caster, context);
                    Caster.Mana -= mana;

                    MasteryBuffInfo.RemoveBuff(Caster, BuffIcon.WhiteTigerForm);
                    return;
                }
                else
                {
                ...
                Caster.NetState.SendSpeedControl(SpeedControlSetting.Mount);
                ...
                AnimalForm.AddContext(Caster, new AnimalFormContext(timer, null, true, typeof(WhiteTigerFormSpell), null));
                ...
                MasteryBuffInfo.AddBuff(Caster, new MasteryBuffInfo(BuffIcon.WhiteTigerForm, 1155911, 1156060, String.Format("{0}\t{1}\t{2}\t{3}", "20", "5", "", bleedMod.ToString())));
        ...
        public static int GetDamageBonus(Mobile m)
        {
            ...
            if (context != null && context.Type == typeof(WhiteTigerFormSpell))
        ...
        public static bool IsActive(Mobile m)
        {
            ...
            return context != null && context.Type == typeof(WhiteTigerFormSpell);
        }
        ...
        public static void OnHit(Mobile attacker, Mobile defender)
        {
            ...
            if (bleedchance / 100.0 > Utility.RandomDouble())
            {
                ...
                _Table[attacker] = Core.Now + TimeSpan.FromMinutes(1);
            }
        }
        ...
        private static void CheckTable()
        {
            ...
            using var expired = Server.Collections.PooledRefList<Mobile>.Create();
            foreach (var (mobile, expires) in _Table)
            {
                if (mobile.Deleted || expires < Core.Now) { expired.Add(mobile); }
            }
            foreach (var mobile in expired) { _Table.Remove(mobile); }
        }
    }
}
