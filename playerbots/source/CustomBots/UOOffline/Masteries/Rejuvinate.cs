            ...
            if (m != null)
            {
                ...
                else if (CheckBSequence(m))
                {
                    ...
                    if (Caster.Karma > Utility.Random(5000))
                    {
                        ...
                        MasteryBuffInfo.RemoveBuff(m, BuffIcon.Clumsy);
                        MasteryBuffInfo.RemoveBuff(m, BuffIcon.FeebleMind);
                        MasteryBuffInfo.RemoveBuff(m, BuffIcon.Weaken);
                        MasteryBuffInfo.RemoveBuff(m, BuffIcon.Curse);
                        MasteryBuffInfo.RemoveBuff(m, BuffIcon.MassCurse);
                        MasteryBuffInfo.RemoveBuff(m, BuffIcon.MortalStrike);
                        MasteryBuffInfo.RemoveBuff(m, BuffIcon.Mindrot);
                    }
