...
namespace Server.Spells.SkillMasteries
{
	public class FistsOfFurySpell : SkillMasteryMove
	{
        ...
        public override TextDefinition AbilityMessage { get { return (TextDefinition)1155895; } } // You ready yourself to unleash your fists of fury!
            ...
            Timer.DelayCall(TimeSpan.FromMilliseconds(400), () =>
                {
                    ...
                    MasteryBuffInfo.AddBuff(from, new MasteryBuffInfo(BuffIcon.FistsOfFury, 1155930, 1156256, TimeSpan.FromSeconds(duration), from));
        ...
        public override void OnHit(Mobile attacker, Mobile defender, int damage)
        {
            ...
            if (_Table[attacker].Target == defender)
            {
                ...
                if (_Table[attacker].Hit >= 3)
                {
                    ...
                    AOS.Damage(defender, attacker, Utility.RandomMinMax(level + 1, (level * 7) - 1), false, 0, 0, 0, 0, 0, 0, 100);
                    damage = 0;
                }
            }
        }
        ...
        {
            MasteryBuffInfo.RemoveBuff(from, BuffIcon.FistsOfFury);
        }
