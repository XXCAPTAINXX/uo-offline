...
namespace Server.Spells.SkillMasteries
{
    public class SkillMasteryMove : SpecialMove
    {
        ...
        public override bool Validate(Mobile from)
        {
            ...
            if (from.Player && MasteryProgress.Current(from) != MoveSkill)
            {
        ...
        public bool CheckCooldown(Mobile from)
        {
            ...
            {
                double left = (Cooldown[from] - Core.Now).TotalMinutes;
                ...
                {
                    left = (Cooldown[from] - Core.Now).TotalSeconds;
        ...
        public virtual void AddToCooldown(Mobile m)
        {
            if (CooldownPeriod > TimeSpan.MinValue)
            {
                ...
                Cooldown[m] = Core.Now + CooldownPeriod;
