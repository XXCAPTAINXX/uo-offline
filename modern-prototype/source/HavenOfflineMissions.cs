...
namespace Server.HavenPrototype {
 ...
 public class HavenOfflineRoutePicker:HavenMenuGump {
  ...
  void Button(int x,int y,int id,string label){AddButton(x,y,0xFA5,0xFA7,id,GumpButtonType.Reply,0);AddLabelCropped(x+34,y,Math.Max(60,530-x-34),27,0,label);}
