...
namespace Server.HavenPrototype
{
 public sealed class HavenBeaconQuestGump:HavenMenuGump
 {
  ...
  public HavenBeaconQuestGump(Mobile p):base(55,55)
  {
   ...
   string[] text={
    "<B>Jenna:</B> The beacon woke when you arrived. Before we follow it anywhere, let's find out what my expedition was really carrying.<BR><BR>Jenna offers a leveling cape, a starter horse and its bonding apple when you begin. Claim them using the journal buttons.<BR><BR>Start beside the New Haven beacon with Jenna. New arrivals should finish meeting her first. Returning adventurers can join this investigation without replaying their arrival.<BR><BR><B>Reward:</B> 2,500 gold paid into your bank, 20 Haven Marks, an instant bandage-enhancing fountain deed, and the expedition's next clue.",
   ...
   if(phase>=1){FlatButton(24,528,205,20,HavenStoryGifts.Claimed(p,"cape")?"Cape received":"Jenna's leveling cape");FlatButton(249,528,205,21,HavenStoryGifts.Claimed(p,"mount")?"Horse received":"Horse and bonding apple");}
   if(phase==5)FlatButton(474,528,220,22,HavenStoryGifts.Claimed(p,"fountain")?"Fountain received":"Claim fountain deed");
