 ...
 public sealed class HavenBeaconQuestGump:HavenMenuGump
 {
  ...
  public HavenBeaconQuestGump(Mobile p):base(55,55)
  {
   ...
   string[] text={
    ...
    "The beacon unfolds a map of an island refuge. Beside the cove is Mara's expedition mark, still burning gold.<BR><BR><B>Jenna:</B> That's our old refuge. Someone kept the light on.<BR><BR>For a moment another message appears: <I>Rescue route restored. One arrival confirmed.</I><BR><BR>You were not summoned as a weapon. You were an answer to a call for help.<BR><BR><B>Reward received:</B> 2,500 gold banked and 20 Haven Marks. Claim your expedition fountain deed below. Place it in your house to enhance every deposited bandage immediately.<BR><BR>Choose Continue adventure below to prepare with Jenna and prepare at the Haven expedition camp."
   };
   ...
   if(phase==5)FlatButton(24,387,420,8,"Continue adventure");
