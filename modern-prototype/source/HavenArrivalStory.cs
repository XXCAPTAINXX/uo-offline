...
namespace Server.HavenPrototype
{
 ...
 public sealed class HavenArrivalStoryGump:HavenMenuGump
 {
  ...
  public HavenArrivalStoryGump(Mobile p,int page):base(60,60)
  {
   ...
   AddBackground(0,0,650,475,3000);AddLabel(24,20,0,"THE BEACON BEYOND | "+(_page==0?"An unexpected arrival":"A reason to stay"));
   string text=_page==0?
   ...
   FlatButton(224,375,185,3,"Quest journal");FlatButton(420,375,205,0,"Continue adventuring");FlatButton(24,415,190,4,"Replay Jenna greeting");FlatButton(224,415,185,5,HavenBeaconQuest.VoiceEnabled(p)?"Voice: on":"Voice: muted");AddLabel(24,450,0,first?"Meet Jenna beside the New Haven beacon. [story reopens this page.":"Story replay only. Your location and progress are preserved.");
  }
  public override void OnResponse(NetState state,RelayInfo info)
  {
   ...
   else if(info.ButtonID==4){HavenBeaconQuest.Speak(_owner,0,true);HavenArrivalStory.Show(_owner,_page);return;}
   else if(info.ButtonID==5){HavenBeaconQuest.ToggleVoice(_owner);HavenArrivalStory.Show(_owner,_page);return;}
