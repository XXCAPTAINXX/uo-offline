...
namespace Server.HavenPrototype {
 public class HavenMenuGump:Gump {
  ...
  public new void AddButton(int x,int y,int normal,int pressed,int id,GumpButtonType type,int page){base.AddButton(x,y,normal==0xFA5?2151:normal,pressed==0xFA7?2152:pressed,id,type,page);}
  ...
  public static void ItemArrow(Gump g,Mobile viewer,Item item,int x,int y,int id){g.AddButton(x,y,2151,2152,id,GumpButtonType.Reply,0);item.SendPropertiesTo(viewer);g.AddItemProperty(item.Serial);}
 }
}
