...
public sealed class HavenAnimalLoreGump : Gump
{
    ...
    private static readonly SkillName[] MagicSkills = new[]{SkillName.Magery, SkillName.EvalInt, SkillName.Meditation, SkillName.Necromancy, SkillName.SpiritSpeak, SkillName.Mysticism, SkillName.Focus, SkillName.Spellweaving, SkillName.Musicianship, SkillName.Discordance, SkillName.Peacemaking, SkillName.Provocation};
    ...
    internal HavenAnimalLoreGump(Mobile viewer, BaseCreature pet) : base(20, 20)
    {
        ...
        AddHtml(28, 49, 280, 44, $"<BASEFONT COLOR=#FFFFFF>{System.Net.WebUtility.HtmlEncode(pet.Name)}</BASEFONT>");
        ...
        if (HavenLoreCompatibility.Owned(viewer, pet)) { Button(28, 640, 1, "Animal Training"); }
    ...
    private void Vital(int y, string attribute, int value, string vital, int current, int maximum, int regen, bool enabled)
    {
        ...
        // Attribute regeneration shown here excludes natural skill and species recovery.
