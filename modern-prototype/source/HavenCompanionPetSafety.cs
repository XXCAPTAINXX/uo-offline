...
namespace Server.HavenPrototype
{
 public partial class HavenCompanion
 {
  ...
  public override bool CanBeHarmful(IDamageable target,bool message,bool ignoreOurBlessedness){if((target==_tamingTarget||WildCustomPet(target as Mobile))&&!_checkingPetOrder&&!_calmingAnimal&&!(_explicitPetTarget==target&&ControlOrder==OrderType.Attack&&ControlTarget==target))return false;return base.CanBeHarmful(target,message,ignoreOurBlessedness);}
