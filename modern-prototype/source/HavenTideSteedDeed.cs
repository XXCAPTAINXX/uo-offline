...
{
    [Constructable] public HavenTideSteedDeed() : base(0x14F0) { Name = "Tidebound sea horse charter"; Hue = 0x482; Weight = 1; LootType = LootType.Blessed; }
    public HavenTideSteedDeed(Serial serial):base(serial){}
    ...
    internal bool Claim(Mobile from)
    {
        ...
        steed.BondingBegin = DateTime.UtcNow - TimeSpan.FromDays(8); steed.MoveToWorld(from.Location, from.Map); Delete(); return true;
    }
