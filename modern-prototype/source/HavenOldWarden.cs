...
namespace Server.HavenPrototype {
 ...
 public class HavenOldWarden:BaseCreature {
  ...
  public override void GenerateLoot(){AddLoot(LootPack.Rich);if(m_Spawning)return;PackGold(1500,2500);PackItem(Gear(m_KillersLuck));PackItem(Gear(m_KillersLuck));if(Utility.RandomDouble()<0.15){var factories=new Func<Item>[]{()=>new BraceletOfTheVanguard(),()=>new BraceletOfArcaneFocus(),()=>new BraceletOfTheWind(),()=>new BraceletOfTheBeastmaster(),()=>new BraceletOfTheVirtuoso(),()=>new BraceletOfTheArtisan(),()=>new BraceletOfFortune(),()=>new BraceletOfTheGuardian(),()=>new BraceletOfTheNight()};PackItem(factories[Utility.Random(factories.Length)]());}}
