...
namespace Server.HavenPrototype {
 public static class HavenLegendaryInnates {
  ...
  public static string Describe(IEnumerable<SkillName> rolls){return "Free innate use: "+string.Join(", ",Granted(rolls).Where(s=>Actions.Contains(s)).Select(s=>s.ToString()))+". Supporting skills start at 100; higher skills are kept. Passive rolls work through normal combat rules. No training points or ability slots spent.";}
