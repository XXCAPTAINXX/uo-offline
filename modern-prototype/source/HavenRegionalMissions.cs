...
namespace Server.HavenPrototype {
 public static class HavenRegionalMissions {
  public static readonly CompanionMission[] Kinds={CompanionMission.Reagents,CompanionMission.MalasReagents,CompanionMission.DoomBones,CompanionMission.AbyssEssences,CompanionMission.AbyssIngredients,CompanionMission.JewelRecovery,CompanionMission.EnchantedTimber,CompanionMission.DragonSalvage};
  public static readonly string[] Names={"Magery reagents","Malas: necromantic reagents","Malas: Doom bones","Abyss: essences","Abyss: rare ingredients","Ruins: jewel recovery","Heartwood: enchanted timber","Eodon: dragon salvage"};
  public static bool Valid(CompanionMission k){return Array.IndexOf(Kinds,k)>=0;}
  public static int Requirement(CompanionMission k){return k==CompanionMission.JewelRecovery?70:k==CompanionMission.EnchantedTimber?85:k==CompanionMission.DragonSalvage?95:k==CompanionMission.MalasReagents?40:k==CompanionMission.DoomBones?60:k==CompanionMission.AbyssEssences?80:k==CompanionMission.AbyssIngredients?100:0;}
