...
namespace Server.HavenPrototype {
 public sealed class HavenShopEntry {
  public string Name,Details; public int Gold,Marks; public Func<Item> Create;
  public HavenShopEntry(string n,int gold,Func<Item> create,string details,int marks=0){Name=n;Gold=gold;Create=create;Details=details;Marks=marks;}
 }
 public static class HavenSupplyShops {
  ...
  static List<HavenShopEntry> Arcane(){return new List<HavenShopEntry>{
   ...
   new HavenShopEntry("Gatherer's resource pouch",15000,()=>new HavenResourceSatchel(),"Keeps mining, lumber, fishing and skinning resources as real items with90% less weight. Collect from items or nested bags. Includes gems and rare harvesting materials."),
