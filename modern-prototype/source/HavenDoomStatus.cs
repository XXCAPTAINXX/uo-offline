    ...
    public static class HavenDoomStatus
    {
        ...
        public static void Initialize()
        {
            CommandSystem.Register("doom", AccessLevel.Player, e =>
            {
                ...
                player.SendMessage("Your next qualifying boss adds points before rolling. Luck gives 50% more bonus points, plus the 25% solo point bonus; points reset when an artifact is awarded.");
                player.SendMessage("This is a chance per eligible boss kill, not a fixed number of kills until a drop. Companion Doom reconnaissance also adds points. Use [doom again to refresh.");
            });
        }
    }
}
