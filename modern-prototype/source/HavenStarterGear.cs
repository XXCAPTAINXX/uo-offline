...
namespace Server.HavenPrototype {
 ...
 public static class HavenStarterGear {
  ...
  public static void Properties(IHavenStarterGear g,ObjectPropertyList list){list.Add(g.Kind==4?"Robe upgrade tier: "+g.Progress.Tier+"/4":HavenLevelProperties.Line(Level(g),g.Progress.Experience,Limit(g)));if(g.Progress.Owner!=null)list.Add("Bound to: "+g.Progress.Owner.Name);}
