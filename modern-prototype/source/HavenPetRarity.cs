...
namespace Server.HavenPrototype
{
    ...
    public class HavenPetRarity : Item
    {
        ...
        public static void Attach(BaseCreature pet,int tier){if(Find(pet)!=null)return;if(pet.Backpack==null)pet.AddItem(new Backpack());pet.Backpack.DropItem(new HavenPetRarity(tier));}
