...
namespace Server.HavenPrototype {
 internal static class HavenLoreCompatibility {
  ...
  public static string RarityDescription(int tier){switch(tier){case 1:return "+10% starting stats/HP; +5 wild combat skills; tamed caps 100 unless raised by scrolls; strengthened species signature, no training cost";case 2:return "+20% starting stats/HP; +10 wild combat skills; tamed caps 100 unless raised by scrolls; stronger signature and species-specific secondary effects, no training cost";case 3:return "Found with 1 follower slot; +30% starting stats/HP; +15 wild combat skills; 3-5 random skill caps at 125-150; all skills lose levels on taming; other tamed caps 100 until raised by scrolls; strongest species signature, no training cost";default:return "Standard species stats and abilities";}}
